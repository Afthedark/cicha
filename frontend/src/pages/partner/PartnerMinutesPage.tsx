    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-cicha-navy via-[#004b87] to-cicha-navy p-6 sm:p-8 rounded-3xl border border-blue-400/20 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-black text-xs sm:text-sm px-5 py-3 rounded-2xl shadow-lg transition-all hover:scale-102 active:scale-98 shrink-0 cursor-pointer"
        >
      ...
      {/* Notifications */}
      {successMessage && (
        <div className="flex items-center gap-3 p-4 bg-emerald-950/80 border border-emerald-400/40 text-emerald-200 rounded-2xl text-xs sm:text-sm animate-in fade-in duration-300 shadow-md">
      ...
      <div className="bg-[#003866]/85 p-4 rounded-2xl border border-blue-400/20 shadow-lg flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="text-xs text-sky-200 font-medium">
          Mostrando <strong className="text-white font-bold">{minutes.length}</strong> {minutes.length === 1 ? 'acta registrada' : 'actas registradas'}
        </div>
      </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex flex-wrap items-center gap-2">
                      {isPdf ? (
                        ...
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-cyan-500/20 text-cyan-200 border border-cyan-400/30 font-bold text-[11px] uppercase tracking-wider">
                    ...
                    {userAllowedToDelete && (
                      <button
                        ...
                        className="text-sky-300/60 hover:text-rose-400 p-1 rounded-lg hover:bg-rose-500/20 transition-all"
                      >
